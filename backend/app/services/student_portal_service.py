...
DEFAULT_VIDEO_SAMPLES: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "thumbnail_url": "https://images.unsplash.com/photo-1559757175-5700dde675c5?auto=format&fit=crop&w=1200&q=80",
    },
    {
        "subject": "Chemistry",
        ...
        "video_url": "https://storage.googleapis.com/coverr-main/mp4/Filtering.mp4",
    ...
    },
    {
        ...
        "video_url": "https://storage.googleapis.com/coverr-main/mp4/Singapore.mp4",
    ...
    },
    {
        ...
        "video_url": "https://storage.googleapis.com/coverr-main/mp4/Nature-Sunset.mp4",
...
def get_video_detail(
    *,
    ...
    return _prepare_video_payload(video)
...
def list_video_comments(
    *,
    ...
    if video is None or video.get("admin_id") != current_context["admin_id"]:
        raise HTTPException(status_code=status.HTTP_404_NOT_FOUND, detail="Video not found")
    return student_portal_video_repository.list_comments(video_id, limit=limit)
...
def list_watched_videos(
    *,
    ...
    prepared_records = [_prepare_video_payload(record) for record in records]
    return {
        "summary": summary,
