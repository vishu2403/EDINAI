...
const AdminDashboard = () => {
  ...
  const creditsDisplay = creditSummary.total !== null
    ? `${creditSummary.remaining ?? 0}/${creditSummary.total}`
    : creditLoading
      ? '...'
      : `${creditSummary.used}`;
  const creditsCaption = creditSummary.total !== null
    ? `Used ${creditSummary.used}${creditSummary.remaining !== null ? ` • Remaining ${creditSummary.remaining}` : ''}`
