...
class ChapterOverviewUpdate(BaseModel):
    std: Optional[str] = Field(default=None, description="Updated class/standard")
    subject: Optional[str] = Field(default=None, description="Updated subject name")
    sem: Optional[str] = Field(default=None, description="Updated semester label")
    board: Optional[str] = Field(default=None, description="Updated board name")
    chapter_number: Optional[str] = Field(default=None, description="Updated chapter number")
    chapter_title: Optional[str] = Field(default=None, description="Updated chapter title override")

    @model_validator(mode="after")
    def ensure_at_least_one_field(cls, values: "ChapterOverviewUpdate") -> "ChapterOverviewUpdate":
        if not any(
            values.__dict__.get(field) not in (None, "")
            for field in ("std", "subject", "sem", "board", "chapter_number", "chapter_title")
        ):
